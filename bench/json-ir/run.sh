#!/bin/sh
# Instruction counts for the JSON validator, under callgrind. Run inside WSL.
#
...
valgrind --tool=callgrind --callgrind-out-file=callgrind.out \
         --cache-sim=no --branch-sim=no "./$bin" 2>&1 | grep -E "checksum|files|refs:"
echo "--- per file ---"
